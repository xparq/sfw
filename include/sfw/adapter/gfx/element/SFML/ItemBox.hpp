...
#include "sfw/util/cpp.hpp" // MIXIN()
...
public:
	...
	fVec2 contentSize() const {
		if constexpr (std::is_convertible_v<T, sfw::/*!!gfx!!*/Text>) { return fVec2(m_item.size()); } //!! This should become part of the Shape concept though!
