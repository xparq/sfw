...
namespace sfw
{
	struct Orientation
	/*
	2D orientation (typically on-screen) of geometric entities

	- The interpretation of Horizontal|Vertical as "diagonal" is
	...
	//!! names, where that makes sense. Also, implicit num. conversions work.
 	//!! `enum class` would also forbid all the num. ops. (despite `: int`)! :-/
	*/
	{
		enum _symbolic_ : int
		{
...
#endif // _UOTYNDUFTN78FN747852B678C46B78V5Y_
